...
public class  Twitter{
	...
	public static void main(String[] args) throws FileNotFoundException{
		...
		if (args.length < 0){
			...
			System.out.println("Usage: java Twitter FileName + (multiple file name allowed)");
		}
		//number of arguments is valid
			...
			for(int i = 0 ; i < args.length; i++){
				...
				//list containing all the tweets from one user. Used to construct the list
				//of lists of all tweets.
